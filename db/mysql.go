...
var MysqlRepo = new(Mysql)

// InitMysqlDB 连接数据库
func (m *Mysql) InitMysqlDB(dataSource string) (err error) {
...
// Find 查询数据库
func (m *Mysql) Find(sql string, args ...interface{}) ([]map[string]interface{}, error) {
...
// First 查询一行数据,即1维数据
func (m *Mysql) First(sql string, args ...interface{}) (map[string]interface{}, error) {
	stmt, err := m.DB.Prepare(sql)
	if err != nil {
		return nil, err
	}
...
func (m *Mysql) Pluck(sql string, name string, args ...interface{}) ([]interface{}, error) {
	stmt, err := m.DB.Prepare(sql)
	if err != nil {
		return nil, err
	}
...
// Delete 删除
func (m *Mysql) Delete(sql string, args ...interface{}) (int64, error) {
	stmt, err := m.DB.Prepare(sql)
	if err != nil {
		return 0, err
	}
